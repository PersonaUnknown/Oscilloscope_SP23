...
#
# Generated by Vivado on Fri Jan 20 22:10:55 -0600 2023
...
xv_boost_lib_path=D:/Xilinx_2020.2/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot fifo_generator_0 xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Xilinx_2020.2/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
